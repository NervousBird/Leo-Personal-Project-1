...
function ReccuringForm() {
  // Can eventually use the user database to grab all the info at once (on the main page)
  // Then give data from the main page to needed components
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Create non existing database entries
